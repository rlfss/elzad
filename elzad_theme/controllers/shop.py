...
class WebsiteSale(ProductConfiguratorController):
    ...
    def shop(self, page=0, category=None, search='', ppg=False, **post):
        ...
        for i, prod in enumerate(products):
            listproducts.append({'product': prod, 'x': 1, 'y': 1, 'class': ''})
            if ((i + 1) % 4) == 0:
    ...
    def create_product_variant(self, product_template_id, product_template_attribute_value_ids, **kwargs):
        ...
        return super(WebsiteSale, self).create_product_variant(product_template_id,
                                                               product_template_attribute_value_ids, **kwargs)

    @http.route(['/product_configurator/show_optional_products_website'], type='json', auth="public", methods=['POST'],
                website=True)
    ...
    @http.route(['/product_configurator/optional_product_items_website'], type='json', auth="public", methods=['POST'],
                website=True)
